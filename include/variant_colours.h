...
enum hue_direction
{    
    HUE_DIR_CENTER = 0,   // +/- of max hue shift  
    HUE_DIR_UP     = 1,   // shift up 
    HUE_DIR_DOWN   = 2,   // shift down
};
...
#define DEFAULT_SPECIES_VARIANT \
  {                             \
      PAL1(1, 15),              \
      HCL1(0, 0, 0, FALSE, HUE_DIR_CENTER),    \
  }
...
static const struct SpeciesVariant gSpeciesVariants[NUM_SPECIES] = 
{
    [SPECIES_BULBASAUR] = {
        PAL1(2, 5),
        HCL1(45, 0, 0, TRUE, HUE_DIR_CENTER),
    },
    [SPECIES_IVYSAUR] = {
        PAL1(6, 4),
        HCL1(45, 0, 5, TRUE, HUE_DIR_CENTER),
    },
    [SPECIES_VENUSAUR] = {
        PAL1(1, 4),
        HCL1(45, 0, 0, TRUE, HUE_DIR_CENTER),
    ...
    [SPECIES_CHARMANDER] = {
        PAL1(6, 4),
        HCL1(30, 0, 10, TRUE, HUE_DIR_CENTER),
    },
    [SPECIES_CHARMELEON] = {
        PAL1(4, 4),
...
static const struct SpeciesVariant gSpeciesShinyVariants[NUM_SPECIES] = 
{
  ...
  [SPECIES_CHARMANDER] = {
    PAL1(9, 6),
    HCL1(180, 0, 0, TRUE, HUE_DIR_CENTER),
  },
  [SPECIES_CHARMELEON] = {
    PAL1(13, 3),
    HCL1(180, 0, 0, TRUE, HUE_DIR_CENTER),
