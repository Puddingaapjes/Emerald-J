...
{
    [BALL_TOP_FIRST]        = {SPECIES_BULBASAUR, 5, GRASS_STARTER},
    [BALL_TOP_SECOND]       = {SPECIES_CHARMANDER, 5, FIRE_STARTER},
    [BALL_MIDDLE_FIRST]     = {SPECIES_SQUIRTLE, 5, WATER_STARTER},

    [BALL_TOP_THIRD]        = {SPECIES_TREECKO, 5, GRASS_STARTER},
    [BALL_TOP_FOURTH]       = {SPECIES_GROWLITHE, 5, FIRE_STARTER},
    [BALL_MIDDLE_THIRD]     = {SPECIES_EEVEE, 5, WATER_STARTER},

    [BALL_MIDDLE_SECOND]    = {SPECIES_MUDKIP, 5, WATER_STARTER},
    [BALL_BOTTOM_FIRST]     = {SPECIES_TORCHIC, 5, FIRE_STARTER},
    [BALL_BOTTOM_SECOND]    = {SPECIES_PIKACHU, 5, GRASS_STARTER},
};
